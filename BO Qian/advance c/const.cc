...
public:
	...
	// const parameters
	void setAge(const int& a) {   // using const we not allowing function to change value of parameter passed to it
		age = a;
	}
	void setAge(int& a) {
		age = a;
	...
	// const function
	// const function cannot change the data members of this class
	// We cannot call non-constant function inside const-function in any case
	// const can be used to overload a non-const function (but then what is the invoking mechanism ? )
...
int main() {
	Dog d;
	d.printDogName();   //  it call non const version of printDogName

	const Dog d2;
	d2.printDogName();   //  it call  const version of printDogName

...
int main()
{
    ...
    string nickname = first_name.substr(0, 3); //  get index values from 0 to 2

    cout << "Your nickname is: " << nickname << endl;
    cout << "Hello " << nickname;

    //------------------------------------------------------------------------------------
    // string1.insert(int x,string2); Insert a character within a string starting from  index x
    //------------------------------------------------------------------------------------
    // string user_name;
    ...
    //------------------------------------------------------------------------------------
    string phone_number;
    cout << "\nEnter your phone number w/area code: ";
    getline(cin, phone_number);

    phone_number.erase(0, 4); // erase first 4 characters
